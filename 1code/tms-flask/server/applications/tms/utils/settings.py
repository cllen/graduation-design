...
class Settings(BaseSettings,metaclass=Singleton):
	...
	# 	# 课程管理系统的api
	# 	'client_default_uri':'{}/tms/home'.format('http://localhost:5000'), # 课程管理页面首页
	# 	'client_code2token_api':'{}/tms/token'.format('http://localhost:5000'), # 课程管理系统得到code后，获取token
	...
	# 	'token2userinfo_api':'{}/oauth2/resource/api/v1/user'.format('http://oauth2_resource:5000'), # 统一登录系统的用户信息获取接口
	# }
	pass